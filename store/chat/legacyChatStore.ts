...
import { ChatStoreState, SendMessageResult, Thread, ChatContext, PatientContext } from '@/types/store/legacyChat';
...
const useLegacyChatStore = create<ChatStoreState>((set, get) => ({
  // --- CORE STATE ---
...
export default useLegacyChatStore;
export { useLegacyChatStore };