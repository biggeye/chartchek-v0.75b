              ...
              <form className="space-y-6">
                ...
                <div className="flex items-center">
                  <div className="flex gap-3">
                    ...
                    <Label htmlFor="terms" className="block text-sm/6 text-gray-900">
                      I agree to the{' '}
                      <Link href="/terms" className="font-semibold text-gray-800 hover:text-indigo-500">
                        Terms of Service
                      </Link>{' '}
                      and{' '}
                      <Link href="/privacy" className="font-semibold text-gray-800 hover:text-indigo-500">
                        Privacy Policy
                      </Link>
                    </Label>
                  </div>
                ...
                <div>
                  <SubmitButton 
                    ...
                    className="flex w-full justify-center rounded-md bg-gray-800 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-800"
                  >
                    Create Account
                  </SubmitButton>
                </div>
