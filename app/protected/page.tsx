...
const navigation = [
  { name: 'Chat', href: '/protected', icon: HomeIcon, current: true },
    ...
    <>
      <div>
        ...
        <div className="lg:pl-20 overflow-hidden">
          <div className="sticky top-0 z-40 flex h-10 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-xs sm:gap-x-6 sm:px-6 lg:px-8">
